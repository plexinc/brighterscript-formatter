...
class IndentFormatter {
    ...
    processLine(lineTokens, tokens, ifStatements, parentIndentTokenKinds) {
        ...
        let firstNonWhitespaceToken = null;
        ...
        for (let i = 0; i < lineTokens.length; i++) {
            ...
            if (token.kind !== brighterscript_1.TokenKind.Whitespace && !firstNonWhitespaceToken) {
            ...
            constants_1.IndentSpacerTokenKinds.includes(token.kind) &&
                ...
                if (constants_1.CallableKeywordTokenKinds.includes(token.kind) &&
                    ...
                    // are "type <name> = "
                    (previousNonWhitespaceToken === null || previousNonWhitespaceToken === void 0 ? void 0 : previousNonWhitespaceToken.kind) === brighterscript_1.TokenKind.Equal &&
                    ((_a = util_1.util.getPreviousNonWhitespaceToken(lineTokens, i - 3)) === null || _a === void 0 ? void 0 : _a.kind) === brighterscript_1.TokenKind.Identifier &&
                    ((_b = util_1.util.getPreviousNonWhitespaceToken(lineTokens, i - 5)) === null || _b === void 0 ? void 0 : _b.text.toLowerCase()) === 'type' &&
                    firstNonWhitespaceToken === util_1.util.getPreviousNonWhitespaceToken(lineTokens, i - 5)) {
                    continue;
                }
                ...
                if (parentIndentTokenKind && ((_c = constants_1.IgnoreIndentSpacerByParentTokenKind.get(parentIndentTokenKind)) === null || _c === void 0 ? void 0 : _c.includes(token.kind))) {
