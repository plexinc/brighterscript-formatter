...
function normalizeOptions(options) {
    let fullOptions = Object.assign({ indentStyle: 'spaces', indentSpaceCount: Formatter_1.Formatter.DEFAULT_INDENT_SPACE_COUNT, formatIndent: true, keywordCase: 'lower', compositeKeywords: 'split', removeTrailingWhiteSpace: true, keywordCaseOverride: {}, formatInteriorWhitespace: true, insertSpaceBeforeFunctionParenthesis: false, insertSpaceAroundParameterAssignment: true, insertSpaceBetweenEmptyCurlyBraces: false, insertSpaceAfterConditionalCompileSymbol: false, insertSpaceAfterOpeningAndBeforeClosingNonemptyBraces: true, insertSpaceBetweenAssociativeArrayLiteralKeyAndColon: false, formatMultiLineObjectsAndArrays: true, sortImports: false }, options);
