...
describe('FormattingOptions', () => {
    describe('normalizeOptions', () => {
        it('does not fail with deprecated values for `keywordCaseOverride`', () => {
            (0, chai_1.expect)((0, FormattingOptions_1.normalizeOptions)({
                keywordCaseOverride: {
                    function: 'title',
                    sub: null,
                    if: 'original'
        ...
        it('converts keywordCaseOverride conditional compile tokens to the proper token kind`', () => {
            let options = (0, FormattingOptions_1.normalizeOptions)({
                keywordCaseOverride: {
                    '#const': 'title',
                    '#else': 'title',
                    '#elseif': 'title',
            ...
            (0, chai_1.expect)(options.keywordCaseOverride).to.eql({
                'hashconst': 'title',
                'hashelse': 'title',
                'hashelseif': 'title',
                'hashendif': 'title',
